...
//voert de aanmeld functie uit
if (isset($_POST['submit'])) {
    $username = $_POST['username'];
    $password = $_POST['password'];

    $object = new User();
    $object->Aanmelden($username, $password);
}
...
<head>
    ...
    <link href="./styles/aanmelden.css" rel="stylesheet" type="text/css"/>
...
<!-- form voor aanmeld functie -->
<section id="aanmeld-section">
    <form class="aanmeld-form" action="aanmelden.php" method="post">
        <h1>Sign up</h1>
        ...
        <input type="submit" class="logbtn" value="Sign up" name="submit"/>
